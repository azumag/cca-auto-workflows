#!/bin/bash
#
# Integration test helpers for parallel processing tests
# Common functions extracted from integration test files to eliminate code duplication
...
setup_integration_test_environment() {
    ...
    export GITHUB_TOKEN="test-token-integration-12345"
    export GITHUB_REPOSITORY="test-org/integration-test-repo"
...
# Create integration test workflows with configurable count
create_integration_test_workflows() {
...
# Consolidated workflow generator function
...
# Create resource intensive workflow for stress testing
...
# Simplified mocks focused on essential functionality
create_integration_mocks() {
...
case "$1 $2" in
    ...
    "repo view") echo "test-org/integration-test-repo" ;;
    "api rate_limit")
        ...
        ;;
    "run list"*)
        # Generate reasonable number of runs based on test needs
...
cleanup_integration_processes() {
    # Clean up all integration test artifacts
    local pids
